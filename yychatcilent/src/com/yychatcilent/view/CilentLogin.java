...
public class CilentLogin extends  JFrame implements ActionListener {//类名：CilentLogin，模板，对象的模板
       //定义北部组件
	    JLabel   jlbl1;//定义标签
	...
	public static void main(String[] args) {
		CilentLogin  cilentLogin= new CilentLogin(); //创建对象， 构造   
